...
$query="Select P.name as p_name, P.pid, P.price, medium, A.name as a_name, url, sell 
...
while ($row=mysqli_fetch_array($result)) {
	...
	$url=$row["url"];
	$sell=$row["sell"];
	$owned[]=array('painting_name'=> $painting_name, 'pid'=> $pid, 'price'=>$price ,'medium'=> $medium, 'artist_name'=> $artist_name, 'url'=> $url, 'sell'=> $sell );
}
